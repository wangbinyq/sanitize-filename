...
// source-hash: a1cd27c3b2e00cc26614bd0f4b612cc1b5601957
let wasm;
 ...
 * @returns {string}
 */
export function sanitize(text, rep) {
  try {
    ...
    wasm.sanitize(retptr, ptr0, len0, ptr1, len1);
 ...
 *   exports: { sanitize: typeof sanitize }
 * }>}
 */
